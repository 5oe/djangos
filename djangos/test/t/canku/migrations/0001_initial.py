# -*- coding: utf-8 -*-
# Generated by Django 1.11.12 on 2018-08-18 04:01
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consult_courses', models.ManyToManyField(to='canku.CourseInfo', verbose_name='咨询课程')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cls', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.ClsInfo', verbose_name='所属课堂')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lecture', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.LectureInfo', verbose_name='所属课堂')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('cls', models.ManyToManyField(to='canku.ClsInfo', verbose_name='所在班级')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.StudentInfo', verbose_name='学员'),
        ),
        migrations.AddField(
            model_name='questioninfo',
            name='student',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.StudentInfo', verbose_name='提问学生'),
        ),
        migrations.AddField(
            model_name='lectureinfo',
            name='teacher',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.UserInfo', verbose_name='上课老师'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='consultant',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.UserInfo', verbose_name='课程顾问'),
        ),
        migrations.AddField(
            model_name='customerinfo',
            name='introduce_customer',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='canku.CustomerInfo', verbose_name='转介绍学员'),
        ),
        migrations.AddField(
            model_name='customerfollowupinfo',
            name='customer',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.CustomerInfo', verbose_name='客户'),
        ),
        migrations.AddField(
            model_name='customerfollowupinfo',
            name='handler',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.UserInfo', verbose_name='跟进入'),
        ),
        migrations.AddField(
            model_name='clsinfo',
            name='course',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.CourseInfo', verbose_name='所学课程'),
        ),
        migrations.AddField(
            model_name='clsinfo',
            name='school',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.SchoolInfo', verbose_name='所属校区'),
        ),
        migrations.AddField(
            model_name='clsinfo',
            name='teachers',
            field=models.ManyToManyField(to='canku.UserInfo', verbose_name='教师'),
        ),
        migrations.AddField(
            model_name='answerinfo',
            name='handler',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.UserInfo', verbose_name='回答者'),
        ),
        migrations.AddField(
            model_name='answerinfo',
            name='question',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='canku.QuestionInfo', verbose_name='问题'),
        ),
